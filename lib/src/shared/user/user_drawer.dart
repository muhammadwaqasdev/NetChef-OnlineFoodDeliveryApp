...
class UserDrawer extends StatelessWidget {
  ...
  const UserDrawer({this.onDrawerCloseTap, this.isGoalSetup = false, required this.user});
        ...
        children: [
          Container(
            ...
            child: ClipRRect(
              ...
              child: Image.network(
                user?.profile ?? "https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg",
                fit: BoxFit.cover,
              ),
            ),
          ),
          Column(
            children: [
              ...
              _iconControl(context,
                  icon: Images.cartWhiteVector,
                  size: Size(30, 30),
                  onTap: () {
                NavService.userCart();
                  }),
              _iconControl(context,
                  icon: Images.notificationWhiteVector,
                  size: Size(30, 30),
                  onTap: () {}),
              _iconControl(context,
          ...
          _iconControl(context, icon: Images.logoutVector, size: Size(30, 30),
              onTap: () async{
                ...
                bool isDone = await firebase.signOutCustomerUser();
                if(isDone){
                  NavService.login();
                }
          }),
